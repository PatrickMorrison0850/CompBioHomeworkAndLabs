...
Average <- .4
#Total number of people including myself is guests + 1 (me)
Total <- Guests + 1
#How many bags of chips will be left over
...
#Each persons ranking of each of the Star wars movies.  The first number is the persons ranking of Episode I and the second is their ranking of episode II and so on
self <- c(7, 6, 5, 1, 2, 3, 4)
Penny <- c(5, 7, 6, 3, 1, 2, 4)
Jenny <- c(4, 3, 2, 7, 6, 5, 1)
Lenny <- c(1, 7, 3, 4, 6, 5, 2)
Stewie <- c(6, 7, 5, 4, 3, 1, 2)
#This is Penny's ranking of episode IV
PennyIV <- Penny[4]
#This is the sum of the rankings put into a matrix
SumRankings <- cbind(Self, Penny, Jenny, Lenny, Stewie)
str(PennyIV)
str(Penny)
str(SumRankings)
#This puts the matrix into a data frame
...
#Switch episodes 2 and 5 rankings for Lenny
