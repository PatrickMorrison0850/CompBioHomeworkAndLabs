...
for (n in seq(1,8)) {
  (NewAmmount + (WeeklyAllowence - (2 * GumPrice))) -> NewAmmount
  print(NewAmmount)
} 
...
names(DeltaCO2[,2]) -> "% Change Total"
names(DeltaCO2[,3]) -> "% Change Cement"
names(DeltaCO2[,4]) -> "% Change Gas"
names(DeltaCO2[,5]) -> "% Change Solids"
names(DeltaCO2[,6]) -> "% Change Liquids"
names(DeltaCO2[,7]) -> "% Change Gas Flare"
